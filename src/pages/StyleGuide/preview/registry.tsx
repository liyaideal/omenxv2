...
export const previewRegistry: Record<string, Loader> = {
  ...
  "wallet-lite-tx-pro-only": pick(walletLite, "TxProOnlyTypesPreview"),
  "wallet-lite-addresses-empty": pick(walletLite, "SavedAddressesEmptyPreview"),
  "wallet-lite-hero-hidden": pick(walletLite, "HeroEquityHiddenPreview"),
  "wallet-lite-deposit-dialog-checklist": pick(walletLite, "DepositDialogChecklistPreview"),
  "wallet-lite-deposit-dialog-address": pick(walletLite, "DepositDialogAddressPreview"),
  "wallet-lite-deposit-dialog-fiat": pick(walletLite, "DepositDialogFiatPreview"),
  "wallet-lite-deposit-dialog-wallet": pick(walletLite, "DepositDialogWalletTabPreview"),
  "wallet-lite-withdraw-desktop": pick(walletLite, "WithdrawFormDesktopPreview"),
  ...
  "auth-gate-lite-wallet": pick(auth, "AuthGateLiteWalletPreview"),
  "auth-gate-lite-portfolio": pick(auth, "AuthGateLitePortfolioPreview"),
  "auth-gate-pro": pick(auth, "AuthGateProPreview"),
  "auth-gate-pro-compact": pick(auth, "AuthGateProCompactPreview"),
  "auth-google-chooser": pick(auth, "AuthGoogleChooserPreview"),
