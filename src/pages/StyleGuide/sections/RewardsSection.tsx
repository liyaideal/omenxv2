  ...
  >
    <div className="space-y-10">
      ...
      <SubSection
        ...
        platform="shared"
      >
        <DualDevicePreview previewKey="rewards-kol-band" label="Live KolBandDesktop / KolBandMobile · toggle Mobile·375 for the shipped mobile hero" minHeight={420} />
      </SubSection>
      ...
      <SubSection
        ...
        platform="shared"
      >
        <DualDevicePreview previewKey="rewards-points-notice" label="Live PointsRetiredNoticeCard · dismiss wired to a no-op" minHeight={140} />
      </SubSection>
      ...
      <SubSection
        ...
        platform="shared"
      >
        <DualDevicePreview previewKey="rewards-fine-print" label="Live RewardsFinePrint · 11.5px / #6B7280" minHeight={110} />
      </SubSection>
