...
const CASES: SectionCase[] = [
  ...
  },
  {
    ...
    spec: [
      ...
      { state: "instant 句组", when: "payoutMode === 'instant'", visual: "底行标签「Credited to wallet」；脚注逐字：Profit goes straight to your wallet on settlement. Losses are floored at $0 — your wallet is never debited.", source: "CloseVoucherContent isInstant 分支" },
      { state: "tiered 句组", when: "payoutMode !== 'instant'", visual: "底行标签「Added to pending」；脚注逐字：Profit lands in your pending balance, unlocked by volume. Losses are floored at $0 — your wallet is never debited.", source: "CloseVoucherContent isInstant 分支" },
