  ...
  >
    <div className="space-y-10">
      ...
      <SubSection
        ...
        description="Mirror of EventPickerList (hook-driven in production). BOOST / STANDARD line badges, neutral mono prices, 1px outline Buy button on binary cards, Yes/No pair on multi-option, volt Picked state, price-band dim and event-level voucher lock."
        platform="shared"
      >
