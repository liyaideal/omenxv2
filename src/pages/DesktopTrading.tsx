                    ...
                    <TooltipProvider>
                      <Tooltip>
                        ...
                        <TooltipContent className="max-w-[280px] p-3">
                          <p className="text-sm">Mark price is derived from the index price, and reflects the fair market price. Liquidation is triggered by mark price.</p>
                        ...
                        <tr key={index} className="border-b border-border/30 hover:bg-muted/20">
                          ...
                          <td className="px-4 py-2">
                            {order.reduceOnly ? (
                              ...
                              <SideChip side={order.type === "buy" ? "yes" : "no"}>
                    ...
                    {positions.length === 0 && pendingAirdrops.length === 0 ? (
                      ...
                      {positions.map((position, index) => {
                        ...
                        >
                              ...
                              <>
                                ...
                                <td className="px-4 py-2">
                                  {outcome ? (
                                    ...
                                    <SideChip side={position.type === "long" ? "yes" : "no"}>
                          ...
                          <td className="px-4 py-2 text-sm font-mono text-right" title="Estimated, ignores MM buffer">{calcLiqPrice(position.entryPrice, position.leverage, position.type)}</td>
                          ...
                          {/* 研发问题 #5 (2026-09-24): TP/SL column removed — no trigger orders in the engine. */}
                          <td className="px-4 py-2 text-center">
                      ...
                      {pendingAirdrops.map((airdrop) => (
                        <tr key={`airdrop-pending-${airdrop.id}`} className="border-b border-border/30 bg-trading-yellow/5">
                          ...
                          <td className="px-4 py-2">
                            <SideChip side={airdrop.counterSide === "long" ? "yes" : "no"}>
